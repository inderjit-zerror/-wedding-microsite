    ...
    <>
      ...
      <div className="w-full h-fit flex flex-col z-20 COLOR_BG_CREAM  ">
        ...
        <div className="w-full min-h-screen max-sm:h-fit flex max-sm:flex-col">
          ...
          {/* right */}
          <div className="w-1/2 max-sm:w-full h-screen max-sm:h-fit  max-sm:py-[0vh] max-sm:px-[20px] COLOR_TEXT_RED flex flex-col px-12 justify-center items-center">
            <div className="w-[80%] h-fit flex flex-col justify-center items-center img3d-wrapper">

              <img
                src={`/imgs/home/imgH5.png`}
                alt="Img"
                className="w-full imgQ1 object-cover object-center mt-4"
              />
            </div>
        ...
        <div className="w-full min-h-screen  max-sm:h-fit  flex max-sm:flex-col flex-row-reverse">
          ...
          {/* right */}
          <div className="w-1/2 max-sm:w-full h-screen max-sm:h-fit max-sm:py-[0vh] max-sm:px-[20px] COLOR_TEXT_RED flex flex-col px-12 justify-center items-center">
            <div className="w-[80%] max-sm:w-1/2 h-fit  flex flex-col justify-center items-center img3d-wrapper">
        ...
        <div className="w-full min-h-screen  max-sm:h-fit  flex max-sm:flex-col">
          ...
          {/* right */}
          <div className="w-1/2 max-sm:w-full overflow-hidden h-screen bg-transparent max-sm:h-fit max-sm:pb-[10vh]  max-sm:px-[20px] COLOR_TEXT_RED flex flex-col px-12 justify-center items-center">
            <div className="w-[80%]  h-fit  flex flex-col justify-center bg-transparent img3d-wrapper items-center">
              <img
                src={`/imgs/home/imgH5.png`}
                alt="Img"
                className="w-full imgQ1 object-cover object-center mt-4 bg-transparent"
              />
            </div>
          </div>
        </div>
